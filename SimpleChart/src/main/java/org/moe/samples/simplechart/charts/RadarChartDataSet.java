...
public class RadarChartDataSet extends LineRadarChartDataSet implements IRadarChartDataSet {
    ...
    public native RadarChartDataSet initWithEntries(NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native RadarChartDataSet initWithEntriesLabel(NSArray<? extends ChartDataEntry> entries, String label);
