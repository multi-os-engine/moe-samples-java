...
@ObjCClassBinding
public class BubbleChartRenderer extends
	...
	public native void drawDataSetWithContextDataSet(CGContextRef context,
			@Mapped(ObjCObjectMapper.class) IBubbleChartDataSet dataSet);
	...
	public native BubbleChartRenderer initWithAnimatorViewPortHandler(
	...
	public native BubbleChartRenderer initWithDataProviderAnimatorViewPortHandler(
			@Mapped(ObjCObjectMapper.class) BubbleChartDataProvider dataProvider,
			ChartAnimator animator, ChartViewPortHandler viewPortHandler);

	@Generated
	@Selector("initWithViewPortHandler:")
	public native BubbleChartRenderer initWithViewPortHandler(
	...
	public native void setDataProvider_unsafe(
			@Mapped(ObjCObjectMapper.class) BubbleChartDataProvider value);
