...
public class ChartHighlighter extends NSObject implements IChartHighlighter {
	...
	public native ChartHighlight getHighlightWithXY(@NFloat double x,
			@NFloat double y);

	@Generated
	@Selector("getHighlightWithXValue:x:y:")
	public native ChartHighlight getHighlightWithXValueXY(double xVal,
			@NFloat double x, @NFloat double y);

	@Generated
	@Selector("getHighlightsWithXValue:x:y:")
	public native NSArray<? extends ChartHighlight> getHighlightsWithXValueXY(
			double xValue, @NFloat double x, @NFloat double y);

	@Generated
	@Selector("getValsForTouchWithX:y:")
	@ByValue
	public native CGPoint getValsForTouchWithXY(@NFloat double x,
			@NFloat double y);
	...
	public native ChartHighlighter initWithChart(
			@Mapped(ObjCObjectMapper.class) Object chart);
	...
	@Generated
	@Selector("setChart:")
	public native void setChart_unsafe(
			@Mapped(ObjCObjectMapper.class) ChartDataProvider value);
