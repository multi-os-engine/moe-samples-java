...
public class BubbleChartDataEntry extends ChartDataEntry {
	...
	public native BubbleChartDataEntry initWithXYSize(double x, double y,
			@NFloat double size);

	@Generated
	@Selector("initWithX:y:size:data:")
	public native BubbleChartDataEntry initWithXYSizeData(double x, double y,
			@NFloat double size, @Mapped(ObjCObjectMapper.class) Object data);
	...
	public native BubbleChartDataEntry initWithYData(double y,
			@Mapped(ObjCObjectMapper.class) Object data);
