...
public class ZoomChartViewJob extends ChartViewPortJob {
	...
	public native ZoomChartViewJob initWithViewPortHandlerScaleXScaleYXValueYValueTransformerAxisView(
			ChartViewPortHandler viewPortHandler, @NFloat double scaleX,
			@NFloat double scaleY, double xValue, double yValue,
			ChartTransformer transformer, @NInt long axis, ChartViewBase view);
