...
public class RadarChartRenderer extends LineRadarChartRenderer {
	...
	public native void drawWebWithContext(CGContextRef context);
	...
	public native RadarChartRenderer initWithAnimatorViewPortHandler(
			ChartAnimator animator, ChartViewPortHandler viewPortHandler);

	@Generated
	@Selector("initWithChart:animator:viewPortHandler:")
	public native RadarChartRenderer initWithChartAnimatorViewPortHandler(
			RadarChartView chart, ChartAnimator animator,
			ChartViewPortHandler viewPortHandler);

	@Generated
	@Selector("initWithViewPortHandler:")
	public native RadarChartRenderer initWithViewPortHandler(
			ChartViewPortHandler viewPortHandler);
