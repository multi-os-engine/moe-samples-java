...
@ObjCClassBinding
public class CandleStickChartRenderer extends
	...
	public native CandleStickChartRenderer initWithAnimatorViewPortHandler(
	...
	public native CandleStickChartRenderer initWithDataProviderAnimatorViewPortHandler(
			@Mapped(ObjCObjectMapper.class) CandleChartDataProvider dataProvider,
			ChartAnimator animator, ChartViewPortHandler viewPortHandler);

	@Generated
	@Selector("initWithViewPortHandler:")
	public native CandleStickChartRenderer initWithViewPortHandler(
	...
	public native void setDataProvider_unsafe(
			@Mapped(ObjCObjectMapper.class) CandleChartDataProvider value);
