...
@ObjCClassBinding
public class LineChartDataSet extends LineRadarChartDataSet implements
		ILineChartDataSet {
	static {
		NatJ.register();
	}
	...
	public native LineChartDataSet initWithValues(
			NSArray<? extends ChartDataEntry> values);

	@Generated
	@Selector("initWithValues:label:")
	public native LineChartDataSet initWithValuesLabel(
	...
	public native void setDrawCubicEnabled(boolean value);
	...
	public native void setDrawSteppedEnabled(boolean value);
