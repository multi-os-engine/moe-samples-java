...
public class ChartFill extends NSObject {
	...
	public native void fillPathWithContextRect(CGContextRef context,
			@ByValue CGRect rect);
	...
	public static native ChartFill fillWithCGImageTiled(CGImageRef CGImage,
			boolean tiled);
	...
	public static native ChartFill fillWithImageTiled(UIImage image,
			boolean tiled);

	@Generated
	@Selector("fillWithLinearGradient:angle:")
	public static native ChartFill fillWithLinearGradientAngle(
			CGGradientRef linearGradient, @NFloat double angle);

	@Generated
	@Selector("fillWithRadialGradient:")
	public static native ChartFill fillWithRadialGradient(
	...
	public static native ChartFill fillWithRadialGradientStartOffsetPercentStartRadiusPercentEndOffsetPercentEndRadiusPercent(
			CGGradientRef radialGradient, @ByValue CGPoint startOffsetPercent,
			@NFloat double startRadiusPercent,
	...
	public native ChartFill initWithCGImageTiled(CGImageRef CGImage,
			boolean tiled);
	...
	public native ChartFill initWithLinearGradientAngle(
			CGGradientRef linearGradient, @NFloat double angle);
