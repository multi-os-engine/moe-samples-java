...
public class ChartTransformer extends NSObject {
	...
	public native ChartTransformer initWithViewPortHandler(
	...
	public native void prepareMatrixValuePxWithChartXMinDeltaXDeltaYChartYMin(
			double chartXMin, @NFloat double deltaX, @NFloat double deltaY,
			double chartYMin);
	...
	@ByValue
	public native CGPoint valueForTouchPointWithXY(@NFloat double x,
			@NFloat double y);
