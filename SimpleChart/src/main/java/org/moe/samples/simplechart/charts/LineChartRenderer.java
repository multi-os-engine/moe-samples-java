...
public class LineChartRenderer extends LineRadarChartRenderer {
	...
	public native void drawHorizontalBezierWithContextDataSet(
	...
	public native LineChartRenderer initWithAnimatorViewPortHandler(
	...
	public native LineChartRenderer initWithViewPortHandler(
	...
	public native void setDataProvider_unsafe(
			@Mapped(ObjCObjectMapper.class) LineChartDataProvider value);
