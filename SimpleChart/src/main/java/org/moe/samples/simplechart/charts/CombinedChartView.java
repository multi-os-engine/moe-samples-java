...
@ObjCClassBinding
public class CombinedChartView extends BarLineChartViewBase implements
		CombinedChartDataProvider, BarChartDataProvider,
	...
	public native CombinedChartView initWithCoder(NSCoder aDecoder);
	...
	public native void setDrawOrder(NSArray<? extends NSNumber> value);
	...
	public native void setFillFormatter(
			@Mapped(ObjCObjectMapper.class) IChartFillFormatter value);
