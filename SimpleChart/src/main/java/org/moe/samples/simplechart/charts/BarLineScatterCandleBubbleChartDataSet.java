...
@ObjCClassBinding
public class BarLineScatterCandleBubbleChartDataSet extends ChartDataSet
		implements IBarLineScatterCandleBubbleChartDataSet {
	static {
		NatJ.register();
	}
	...
	public native BarLineScatterCandleBubbleChartDataSet initWithLabel(
			String label);

	@Generated
	@Selector("initWithValues:")
	public native BarLineScatterCandleBubbleChartDataSet initWithValues(
			NSArray<? extends ChartDataEntry> values);

	@Generated
	@Selector("initWithValues:label:")
	public native BarLineScatterCandleBubbleChartDataSet initWithValuesLabel(
