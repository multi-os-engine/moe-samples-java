...
public class ScatterChartRenderer extends LineScatterCandleRadarChartRenderer {
	...
	public native ScatterChartRenderer initWithAnimatorViewPortHandler(
	...
	public native ScatterChartRenderer initWithDataProviderAnimatorViewPortHandler(
			@Mapped(ObjCObjectMapper.class) ScatterChartDataProvider dataProvider,
			ChartAnimator animator, ChartViewPortHandler viewPortHandler);

	@Generated
	@Selector("initWithViewPortHandler:")
	public native ScatterChartRenderer initWithViewPortHandler(
	...
	public native void setDataProvider_unsafe(
			@Mapped(ObjCObjectMapper.class) ScatterChartDataProvider value);
