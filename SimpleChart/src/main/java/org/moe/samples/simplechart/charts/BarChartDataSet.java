...
@ObjCClassBinding
public class BarChartDataSet extends BarLineScatterCandleBubbleChartDataSet
		implements IBarChartDataSet {
	static {
		NatJ.register();
	}
	...
	public native BarChartDataSet initWithValues(
			NSArray<? extends ChartDataEntry> values);

	@Generated
	@Selector("initWithValues:label:")
	public native BarChartDataSet initWithValuesLabel(
	...
	public native void setBarBorderWidth(@NFloat double value);
	...
	public native void setHighlightAlpha(@NFloat double value);
