...
@ObjCClassBinding
public class CandleChartDataSet extends LineScatterCandleRadarChartDataSet
		implements ICandleChartDataSet {
	static {
		NatJ.register();
	}
	...
	public native CandleChartDataSet initWithLabel(String label);

	@Generated
	@Selector("initWithValues:")
	public native CandleChartDataSet initWithValues(
			NSArray<? extends ChartDataEntry> values);

	@Generated
	@Selector("initWithValues:label:")
	public native CandleChartDataSet initWithValuesLabel(
	...
	public native void setBarSpace(@NFloat double value);
	...
	public native void setDecreasingColor(UIColor value);
	...
	public native void setIncreasingColor(UIColor value);
	...
	public native void setNeutralColor(UIColor value);
	...
	public native void setShadowWidth(@NFloat double value);
