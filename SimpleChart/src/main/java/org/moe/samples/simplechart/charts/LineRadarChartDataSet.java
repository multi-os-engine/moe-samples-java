...
public class LineRadarChartDataSet extends LineScatterCandleRadarChartDataSet implements ILineRadarChartDataSet {
    ...
    public native LineRadarChartDataSet initWithEntries(NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native LineRadarChartDataSet initWithEntriesLabel(NSArray<? extends ChartDataEntry> entries, String label);
