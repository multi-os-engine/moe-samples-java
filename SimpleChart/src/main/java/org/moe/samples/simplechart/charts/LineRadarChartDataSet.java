...
@ObjCClassBinding
public class LineRadarChartDataSet extends LineScatterCandleRadarChartDataSet
		implements ILineRadarChartDataSet {
	static {
		NatJ.register();
	}
	...
	public native LineRadarChartDataSet initWithLabel(String label);

	@Generated
	@Selector("initWithValues:")
	public native LineRadarChartDataSet initWithValues(
			NSArray<? extends ChartDataEntry> values);

	@Generated
	@Selector("initWithValues:label:")
	public native LineRadarChartDataSet initWithValuesLabel(
