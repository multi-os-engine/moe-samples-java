...
@ObjCClassBinding
public class ChartIndexAxisValueFormatter extends NSObject implements
	...
	public native ChartIndexAxisValueFormatter initWithValues(
	...
	@Generated
	@Selector("withValues:")
	public static native ChartIndexAxisValueFormatter withValues(
			NSArray<String> values);
}