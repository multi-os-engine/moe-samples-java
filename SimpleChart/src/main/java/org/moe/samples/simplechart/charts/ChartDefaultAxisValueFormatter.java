...
@ObjCClassBinding
public class ChartDefaultAxisValueFormatter extends NSObject implements
	...
	public native ChartDefaultAxisValueFormatter initWithDecimals(
			@NInt long decimals);

	@Generated
	@Selector("initWithFormatter:")
	public native ChartDefaultAxisValueFormatter initWithFormatter(
