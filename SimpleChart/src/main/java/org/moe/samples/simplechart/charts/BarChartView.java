...
@ObjCClassBinding
public class BarChartView extends BarLineChartViewBase implements
	...
	public native void groupBarsFromXGroupSpaceBarSpace(double fromX,
			double groupSpace, double barSpace);
	...
	public native void highlightValueWithXDataSetIndexStackIndex(double x,
