...
public class PieRadarChartViewBase extends ChartViewBase {
	...
	@NFloat
	public native double distanceToCenterWithXY(@NFloat double x,
			@NFloat double y);

	@Generated
	@Selector("getPositionWithCenter:dist:angle:")
	@ByValue
	public native CGPoint getPositionWithCenterDistAngle(
			@ByValue CGPoint center, @NFloat double dist, @NFloat double angle);
	...
	public native void spinWithDurationFromAngleToAngle(double duration,
			@NFloat double fromAngle, @NFloat double toAngle);
	...
	public interface Block_spinWithDurationFromAngleToAngleEasing {
		@Generated
		double call_spinWithDurationFromAngleToAngleEasing(double arg0,
				double arg1);
	}

	@Generated
	@Selector("spinWithDuration:fromAngle:toAngle:easingOption:")
	public native void spinWithDurationFromAngleToAngleEasingOption(
			double duration, @NFloat double fromAngle, @NFloat double toAngle,
